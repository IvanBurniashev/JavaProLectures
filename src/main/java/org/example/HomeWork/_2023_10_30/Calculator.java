...
public class Calculator {
    ...
    public double power(int base, int exponent) {
        if (base == 0 && exponent == 0) {
            throw new IllegalArgumentException("You can't raise zero to the power zero!");
        } else if (base == 0 && exponent < 0) {
            throw new IllegalArgumentException("You cannot raise zero to a negative power!");
        } else if (exponent == 0) {
            return 1;
        }
        double result = 1;
    ...
    public int findMax(int[] array) {
        return Arrays.stream(array)
                .reduce(Integer.MIN_VALUE, (a, b) -> b > a ? b : a);
    }
    ...
    public long productOfArray(int[] array) {
        return Arrays.stream(array)
                .reduce(1, (multiplication, el) -> multiplication * el);
    }
