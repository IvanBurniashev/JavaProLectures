package org.example.ClassWork._2023_10_11;
...
public class Main {
     ...
     * элемент списка, который делится на заданное число без остатка.
     */
    private static void m2(Integer integer) {
        List<Integer> list = Arrays.asList(10, 15, 20, 25, 32);
        Optional<Integer> max = list.stream()
                .filter(el -> el % integer == 0)
...
//                .filter(el -> el.getName().charAt(0)=='M')
//                .toList();
